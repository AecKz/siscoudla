...
/**
 * Servlet implementation class DashboardCoordinadorController
 */
@WebServlet("/DashboardCoordinadorController")
public class DashboardCoordinadorController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DashboardCoordinadorController() {
		super();
	}
