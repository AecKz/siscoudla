...
<script src="js/controladores/datosEstudiante.js"></script>
...
<!-- 										<li><a href="#">Turno Extra</a></li> -->
								...
								<li><a><i class="fa fa-book"></i>Informes<span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a href="informeTurnosEstudiante.jsp">Turno Normal</a></li>
<!-- 										<li><a href="#">Turno Extra</a></li> -->
									</ul></li>
							</ul>
						</div>
								...
								<div class="x_content">
									...
									<div class="col-md-6 col-sm-6 col-xs-12" align="center">
										<form class="form-horizontal form-label-left">
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="txtMatricula">No Matr&iacute;cula:<span
													class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" class="form-control col-md-7 col-xs-12"
