...
<head>
	...
	<script src="js/controladores/mantenimientoTratamiento.js"></script>
						...
						<div class="menu_section">								
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-book"></i>Informes<span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a href="informeTurnosAdministrador.jsp">Turno Normal</a>
										</li>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div>
									<h3>Mantenimiento de los Tratamientos</h3>
								</div>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_content">
